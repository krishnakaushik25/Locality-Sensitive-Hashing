...
# remove rows with values higher then the thershold value (i.e 16)
...
# renaming the index as id 
data.reset_index(inplace=True)
data.rename({"index": "id"}, axis=1, inplace=True)

# write the clean data to new json file
...
##### The rate increase in click rate from default
